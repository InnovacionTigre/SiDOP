<%@ Page Language="VB" AutoEventWireup="false" CodeFile="AsociarExpediente.aspx.vb" Inherits="AsociarExpediente" MasterPageFile="~/design/MasterPage.master"%>
...
<div style="padding-left:225Px; text-align:center;">
    <asp:Panel ID="Panel1" runat="server" Height="350px" Width="864px">
        ...
        <telerik:RadAjaxPanel ID="RadAjaxPanel1" runat="server" LoadingPanelID="RadAjaxLoadingPanel1" HorizontalAlign="NotSet">
            ...
            <tr>
                ...
                <td style="height: 21px; width: 587px;">
                    &nbsp;<asp:Label ID="lblNroCuenta" runat="server" Text="Label" Width="168px"></asp:Label></td>
        ...
        <asp:SqlDataSource ID="SqlDataSourceExpedientes" runat="server"
            ...
            <SelectParameters>
                <asp:SessionParameter Name="nroCuenta" SessionField="cuenta" Type="String" />
            </SelectParameters>
            <DeleteParameters>
