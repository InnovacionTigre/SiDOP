<%@ Page Language="VB" AutoEventWireup="false" CodeFile="GenerarCarpetasFuerza.aspx.vb" Inherits="GenerarCarpetasFuerza" MasterPageFile="~/design/MasterPage.master"%>
...
<div style="text-align:center">
    <asp:Panel ID="Panel1" runat="server" Height="150px" style="text-align: center" >
        <p><span style="color: #7d0506; font-size: 26px;"><b> Creación de carpetas Fuerza Bruta</b></span></P>
