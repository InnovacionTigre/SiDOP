<%@ Page Language="C#" MasterPageFile="~/design/MasterPageProfesional.master" ValidateRequest="false" AutoEventWireup="true" CodeFile="HistorialCorreoCuenta.aspx.cs" Inherits="HistorialCorreoCuenta" Title="Untitled Page" Culture="auto" meta:resourcekey="PageResource1" UICulture="auto" %>
    ...
    <telerik:RadGrid ID="rGCorreos" runat="server" DataSourceID="SqlDataSourceCorreos"
        ...
        <MasterTableView AutoGenerateColumns="False" DataSourceID="SqlDataSourceCorreos">
            <Columns>
                ...
                <telerik:GridBoundColumn DataField="Asunto de Mensaje" HeaderText="Asunto de Mensaje"
                    SortExpression="Asunto de Mensaje" UniqueName="Asunto de Mensaje" CurrentFilterFunction="Contains" AutoPostBackOnFilter="True" ShowFilterIcon="False">
                </telerik:GridBoundColumn>
